    ...
    const PrintInvoice = () => {
        const rows = allData?.map(item => {
            return `
                    <tr style="border: 1px solid black">
                        <td style="padding: 4px; border-left: 1px solid black; border-right: 1px solid black; border-bottom:1px solid black; font-size: 13px; text-align:center; width: 40px">
                        ...
                        <td style="padding: 4px; border-right: 1px solid black;  border-bottom:1px solid black; text-align:center; font-size: 13px">
        ...
        const footerContent = `
                                    ...
                                    <tr style="background: white;">
                                        ...
                                        <td style="padding: 4px;"></td>
                                        <th style="padding: 4px;"></th>
                                        <td style="padding: 4px;  font-size:13px;">ডেলিভারী</td>
                                        <td style="padding: 4px;"></td>
                                    ...
                                    <tr style="background: white;">
                                        ...
                                        <th style="padding: 4px;"></th>
                                        <td style="padding: 4px;"></td>
                                        <td style="padding: 4px;border-bottom: 1px solid black; font-size:13px;">ডিসকাউন্ট</td>
                                    ...
                                    <tr style="background: white;">
                                        ...
                                        <td style="padding: 4px;font-size:13px; text-align:right;"> ম্যানেজার</td>
                                        <th style="padding: 4px;"></th>
        ...
        const invoiceContent = `
                                ...
                                <body>
                                    <div class="invoice" style="padding-top: 35px">
                                    ${UserInfo}
