        ...
        <div>
            ...
            <div className='flex justify-between '>
                <div className='flex justify-start gap-3 items-center'>
                    ...
                    <div className='flex justify-start items-center gap-3'>
                        <h1 className='font-thin'>:</h1>
                        <input placeholder={`${user?.address}, ${state?.name}`} value={`${user?.address}, ${state?.name}`} readOnly={true} className='border focus:outline-none rounded p-1 font-thin  w-[220px]' />
                    </div>
                </div>
                <div className='flex justify-start gap-3 items-center'>
                    ...
                    <div className='flex justify-start items-center gap-3'>
                        <h1 className='font-thin'>:</h1>
                        <input placeholder={invoice?.date} value={invoice?.date} readOnly={true} className='border focus:outline-none rounded p-1 font-thin' />
                    </div>
                </div>
            </div>
