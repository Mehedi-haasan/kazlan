...
import PreviewPurchasePaymentTotal from '../ReturnInvoice/PurchaseReturnPaymentTotal';
import Edit from '../../icons/Edit';



const PreviewPurchaseReturnInvoice = ({ info = {}, prefix = 'KB', id, type }) => {
        ...
        <div className="">
            ...
            <div className='w-full mx-auto px-10'>
                    ...
                    <div className='relative overflow-x-auto my-5'>
                        <table class="w-full text-sm text-left rtl:text-right text-black font-thin">
                            ...
                            <tbody>
                                ...
                                <PreviewPurchasePaymentTotal user={user} total={total} invoice={invoice} info={info} />
                ...
                <div className='flex justify-between px-7'>
                    ...
                    <div className="flex justify-end my-3 mr-2">
                        <button
                            onClick={() => goto(`/purchase/return/edit/${invoice?.id}/${invoice?.type}`)}
                            className="group border bg-[#FFFFFF] border-green-500 flex shadow-md justify-start items-center gap-1 text-green-500 rounded-lg px-4 py-1.5 ml-3 font-thin hover:bg-green-500 hover:text-white transition duration-200"
                        >
...
export default PreviewPurchaseReturnInvoice;