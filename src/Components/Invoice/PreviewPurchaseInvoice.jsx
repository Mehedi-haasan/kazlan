...
const PreviewPurchaseInvoice = ({ isOrder = true, info = {}, prefix = 'KB', id, type }) => {
                                ...
                                <body>
                                    ...
                                    <table style="border-collapse: collapse; width: 100%;">
                                        ...
                                        <tr style="font-family: 'kalpurush'; font-size: 17px;">
                                            ...
                                            <td style="padding: 4px; text-align: center; border-right: 1px solid black; border-top:1px solid black; border-bottom:1px solid black; text-align:center;  width:60px;">${GetType(invoice?.type)}</td>
