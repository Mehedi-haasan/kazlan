...
const PreviewOpeningInvoice = ({ usertype, prefix = 'KB', info = {}, id, type }) => {
    ...
    const GetReturnProduct = async (id, type) => {
        ...
        let user = data?.user
        user['state'] = data?.state?.name
        setUser(user);
        setInvoice(data?.invoice)
        setState(data?.state)
        if (data?.invoice?.id == data?.lastInvo.id) {
            setPrevNext({
                ...pevNext,
                prev: data?.prevInvo,
                next: data?.nextInvo,
    ...
    function getPaymentDescription(usertype, payment_type) {
        const mapping = {
            Customer: {
                "You Receive": "Received from Customer",
                "You Pay": "Pay to Customer",
                "Yearly Bonus": "Yearly Bonus to Customer",
                "Opening": "Opening Balance of Customer"
            },
            Supplier: {
                "You Receive": "Received from Company",
                "You Pay": "Paid to Company",
                "Yearly Bonus": "Yearly Bonus from Company",
                "Opening": "Opening Balance to Company"
            },
            Expense: {
                "Expense": "Expense"
            }
        ...
        return mapping[usertype]?.[payment_type] || "Unknown type";
    }
    ...
    const PrintInvoice = () => {
                            ...
                            <div style="">
                                 <div style="display: flex; justify-content: flex-start; padding-bottom:5px">
                                    <div style=" padding:5px; width: 130px">
                                      <p style="color: black;  margin: 0px;">Date</p>
                                    </div>
                                    ...
                                    <div style="border: 1px solid black; padding:5px; width: 250px">
                                      <p style="color: black; margin: 0px; font-family: 'times', sans-serif;">${formatDate(invoice?.createdAt)}</p>
                                    </div>
                                </div>
                                ...
                                <div style="display: flex; justify-content: flex-start; padding-bottom:5px">
                                    <div style=" padding:5px; width: 130px">
                                      <p style="color: black;  margin: 0px; font-family">Name</p>
                                    </div>
                                     <div style="display: flex; justify-content: center; align-items: center; width:30px">:</div> 
                                ...
                                <div style="display: flex; justify-content: flex-start; padding-bottom:5px">
                                    <div style=" padding:5px; width: 130px">
                                      <p style="color: black;  margin: 0px; font-family">Address</p>
                                    </div>
                                     <div style="display: flex; justify-content: center; align-items: center; width:30px">:</div> 

                                    <div style="border: 1px solid black; padding:5px; width: 250px">
                                      <p style="color: black; margin: 0px;">${user?.address}, ${state?.name}</p>
                                    </div>
                                </div>

                                <div style="display: flex; justify-content: flex-start; padding-bottom:5px">
                                    <div style=" padding:5px; width: 130px">
                                      <p style="color: black;  margin: 0px; font-family">Receipt Type</p>
                                    </div>
                                     <div style="display: flex; justify-content: center; align-items: center; width:30px">:</div> 

                                    <div style="border: 1px solid black; padding:5px; width: 250px">
                                      <p style="color: black; margin: 0px;">Received from Customer</p>
                                    </div>
                                </div>
                                ...
                                <div style="display: flex; justify-content: flex-start; padding-bottom:5px">
                                    ...
                                    <div style="border: 1px solid black; padding:5px; width: 250px">
                                       ${invoice?.paymentmethod ? `<p style="color: black; margin: 0px;">${invoice?.paymentmethod}</p>` : ``}
                                    </div>
                                </div>
                                ...
                                <div style="display: flex; justify-content: flex-start; padding-bottom:5px">
                                    ...
                                    <div style="border: 1px solid black; padding:5px; width: 250px">
                                      ${invoice?.methodname ? `<p style="color: black; margin: 0px;">${invoice?.methodname}</p>` : ``}
                                    </div>
                                </div>
                                ...
                                <div style="display: flex; justify-content: flex-start; padding-bottom:5px">
                                    ...
                                    <div style="border: 1px solid black; padding:5px; width: 250px">
                                      <p style="color: black; margin: 0px; font-family: 'times', sans-serif;">${prefix}/${ReturnSaleCode(invoice?.type)}-${String(params?.id).padStart(5, '0')}</p>
                                    </div>
                                </div>
                                ...
                                <div style="display: flex; justify-content: flex-start; padding-bottom:5px">
                                    ...
                                    <div style="border: 1px solid black; padding:5px; width: 250px">
                                      <p style="color: black; margin: 0px;">${invoice?.paidamount > 0 ? invoice?.paidamount : invoice?.return}</p>
                                    </div>
                                </div>

                                <div style="display: flex; justify-content: flex-start; padding-bottom:5px">
                                    <div style="padding:5px; width: 130px">
                                      <p style="color: black;  margin: 0px;">Remarks</p>
                                    </div>
                                     <div style="display: flex; justify-content: center; align-items: center; width:30px">:</div> 

                                    <div style="border: 1px solid black; padding:5px; width: 250px">
                                      <p style="color: black; margin: 0px;">${invoice?.note}</p>
                                    </div>
                                </div>
                        </div>
                        `;
        ...
        const invoiceContent = `
                                <html>
                                <head>
                                    <title style="font-family: 'times', sans-serif;">Invoice</title>
                                    <style>
                                    @font-face {
                                        font-family: 'times';
                                ...
                                <body>
                                    <div style="padding-top: 50px; font-family: 'times', sans-serif;">
                                    
                                    <h3 style="text-align:center; margin:3px; padding:3px;">Money Receipt</h3>
                                    ...
                                    <div>
                                       <p style="padding-left: 200px; padding-bottom:0px; margin-bottom:0px;">(কথায় : ${numberToWords(invoice?.paidamount > 0 ? invoice?.paidamount : invoice?.return)})</p>
                                       <p style="padding-left: 200px; padding-top:0px; margin-top:0px;">user : ${invoice?.creator}</p>
                                    </div>
                                    <div style="display:flex; justify-content: space-around; align-items: center; padding-bottom:0px; margin-bottom:0px;">
                                        <p style="text-decoration: overline; padding-bottom:0px; margin-bottom:0px;">Received By</p>
                                        <p style="text-decoration: overline; padding-bottom:0px; margin-bottom:0px;">Authorized Signature</p>
                                    </div>
                                    <div style="display:flex; justify-content: space-around; align-items: center; padding-top:0px; margin-top:0px;">
                                        <p style="padding-top:0px; padding-bottom:0px; margin-bottom:0px; margin-top:0px;">${invoice?.creator}</p>
                                        <p style="padding-top:0px; padding-bottom:0px; margin-bottom:0px; margin-top:0px;">${invoice?.creator}</p>
                                    </div>
                                </body>
                                </html>
    ...
    return (
        <div className="">
            ...
            <div className='w-full mx-auto'>
                <div ref={ref}>
                    <div ref={targetRef} className="bg-[#FFFFFF] rounded p-4 font-thin font-times">
                        <h1 className='text-center text-[18px] pb-4 pt-36 font-bold'>Money Receipt</h1>
                        <div className='flex justify-center items-center'>
                            <div className="pb-4 text-[13px] text-black">
                                {/* Date */}
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black text-[15px]">Date</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]" >
                                        <p className="m-0 text-black text-[15px] font-times align-top" style={{ paddingBottom: '10px' }}>{formatDate(invoice?.createdAt)}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black text-[15px]">Name</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                        <p className="m-0 text-black text-[16px] align-top" style={{ paddingBottom: '10px' }} id="kalpurush">{user?.name}</p>
                                    </div>
                                </div>

                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black text-[15px]">Address</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                        <p className="m-0 text-black text-[16px] align-top" style={{ paddingBottom: '10px' }} id="kalpurush">{user?.address}{usertype === "Supplier" ? '' : `, ${state?.name}`}</p>
                                    </div>
                                </div>

                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black text-[15px]">Receipt Type</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                        <p className="m-0 text-black text-[16px] font-times align-top" style={{ paddingBottom: '10px' }}>{getPaymentDescription(usertype, invoice?.payment_type || type)}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black text-[15px]">Payment Type</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                        <p className="m-0 text-black text-[16px] align-top" style={{ paddingBottom: '10px' }} id="kalpurush">{invoice?.paymentmethod}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black text-[15px]">Bank Name</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                        <p className="m-0 text-black text-[16px] align-top" style={{ paddingBottom: '10px' }} id="kalpurush">{invoice?.methodname}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black text-[15px]">Receipt No</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                        <p className="m-0 text-black text-[15px] font-times align-top" style={{ paddingBottom: '10px' }} >
                                            {prefix}/{ReturnSaleCode(invoice?.type)}-{String(invoice?.id).padStart(5, "0")}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black text-[15px]">Amount</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                        <p className="m-0 text-black text-[15px] font-times align-top" style={{ paddingBottom: '10px' }}>{invoice?.paidamount > 0 ? invoice?.paidamount : invoice?.return}</p>
                                    </div>
                                </div>
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black text-[15px]">Remarks</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                        <p className="m-0 text-black text-[16px] align-top" style={{ paddingBottom: '10px' }} id="kalpurush">{invoice?.note}</p>
                                    </div>
                                </div>
                                ...
                                <div className='flex justify-between items-center font-thin pt-10'>
                                    ...
                                    <div className='text-center'>
                                        <p className='text-overline' style={{ textDecoration: "overline" }}>Authorized Signature</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className='flex justify-between'>
                    ...
                    <div className="flex justify-end my-3">
                        ...
                        <NavLink to={`/edit/${usertype === "Supplier" ? 'supplier' : 'customer'}/balance/${invoice?.userId}/${invoice?.id}/${invoice?.type}`} className='border group border-red-500 text-red-500 bg-[#FFFFFF] shadow-md hover:bg-red-500 hover:text-white group rounded-lg px-4 py-1.5 mx-3 font-thin flex justify-start items-center gap-1'>
                            <Edit size="17px" className={`group-hover:text-white`} /><h1 className="mt-[3px]">Edit</h1>
                        </NavLink>
                        <button onClick={() => generatePDF(targetRef, { filename: `${user?.name}.pdf` })} className='border group border-red-500 text-red-500 bg-[#FFFFFF] shadow-md hover:bg-red-500 hover:text-white group rounded-lg px-4 py-1.5 mr-3 font-thin flex justify-start items-center gap-1'>
                            <svg xmlns="http://www.w3.org/2000/svg" className="group-hover:text-white transition duration-200" width="24" height="24" viewBox="0 0 24 24"><g fill="none"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M7.792 21.25h8.416a3.5 3.5 0 0 0 3.5-3.5v-5.53a3.5 3.5 0 0 0-1.024-2.475l-5.969-5.97A3.5 3.5 0 0 0 10.24 2.75H7.792a3.5 3.5 0 0 0-3.5 3.5v11.5a3.5 3.5 0 0 0 3.5 3.5" /><path fill="currentColor" fillRule="evenodd" d="M10.437 7.141c-.239.078-.392.236-.436.411c-.09.352 0 .73.253 1.203c.126.234.28.471.45.725l.092.137l.145.215l.019-.068l.086-.306q.148-.503.23-1.02c.089-.642-.011-1.018-.309-1.26c-.08-.065-.278-.119-.53-.037m.055 4.152l-.27-.362l-.032-.048c-.115-.19-.243-.38-.382-.585l-.1-.149a10 10 0 0 1-.512-.828c-.31-.578-.558-1.286-.358-2.067c.17-.664.698-1.081 1.227-1.254c.517-.168 1.174-.147 1.66.247c.792.644.848 1.573.739 2.357a9 9 0 0 1-.261 1.174l-.096.34q-.112.382-.208.769l-.067.194l1.392 1.864c.65-.078 1.364-.125 2.03-.077c.769.054 1.595.242 2.158.776a1.56 1.56 0 0 1 .395 1.441c-.117.48-.454.88-.919 1.123c-.985.515-1.902.105-2.583-.416c-.533-.407-1.045-.975-1.476-1.453l-.104-.114c-.37.057-.72.121-1.004.175c-.305.057-.684.128-1.096.22l-.151.443q-.125.288-.238.58l-.122.303a8 8 0 0 1-.427.91c-.33.578-.857 1.192-1.741 1.241c-1.184.066-1.986-.985-1.756-2.108l.006-.027c.2-.791.894-1.31 1.565-1.653c.597-.306 1.294-.532 1.941-.701zm.87 1.165l-.287.843l.421-.08l.004-.001l.38-.07zm2.84 1.604c.274.29.547.56.831.777c.55.42.94.493 1.299.305c.2-.105.284-.241.309-.342a.35.35 0 0 0-.08-.309c-.257-.228-.722-.38-1.392-.428a8 8 0 0 0-.967-.003m-5.005.947c-.318.109-.62.23-.89.368c-.587.3-.87.604-.944.867c-.078.415.192.673.516.655c.27-.015.506-.184.766-.639q.204-.372.358-.767l.107-.266z" clipRule="evenodd" /></g></svg>
                            <span className="group-hover:text-white transition duration-200">PDF</span>
                        </button>
...
export default PreviewOpeningInvoice;