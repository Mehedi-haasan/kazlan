            ...
            <div className='w-full mx-auto'>
                <div ref={ref}>
                    ...
                    <div className='relative overflow-x-auto my-5'>
                        ...
                        <h1 className='text-center text-[18px] pb-4 pt-24 font-bold'>Money Receipt</h1>
                            ...
                            <div className="pb-4 text-[13px] text-black">
                                ...
                                <div className="flex justify-start pb-1.5">
                                    ...
                                    <div className="border border-black p-1.5 w-[350px]">
                                        <p className="m-0 text-black text-[15px] font-times">{formatDate(invoice?.createdAt)}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black">Address</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                ...
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black">Receipt Type</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                        <p className="m-0 text-black text-[16px] font-times">{getPaymentDescription(usertype, invoice?.payment_type)}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black">Payment Type</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                ...
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black">Bank Name</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                ...
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black">Receipt No</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                        <p className="m-0 text-black text-[15px] font-times" >
                                ...
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black">Amount</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                                        <p className="m-0 text-black text-[15px] font-times">{invoice?.paidamount > 0 ? invoice?.paidamount : invoice?.return}</p>
                                    </div>
                                </div>
                                <div className="flex justify-start pb-1.5">
                                    <div className="p-1.5 w-[130px]">
                                        <p className="m-0 text-black">Remarks</p>
                                    </div>
                                    <div className="flex justify-center items-center w-[30px]">:</div>
                                    <div className="border border-black p-1.5 w-[350px]">
                ...
                <div className='flex justify-between'>
                    ...
                    <div className="flex justify-end my-3">
                        {/* to={`/edit/${usertype === "Supplier" ? 'supplier':'customer'}/balance/${invoice?.userId}/${invoice?.id}/${invoice?.type}`} */}
                        <button disabled={true} className='border group border-red-500 text-red-500 bg-[#FFFFFF] shadow-md hover:bg-red-500 hover:text-white group rounded-lg px-4 py-1.5 mx-3 font-thin flex justify-start items-center gap-1'>
