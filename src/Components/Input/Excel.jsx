...
const Excel = ({ Jpg, onClick }) => {
    return <div>
        <button className="border-y border-l rounded-l px-3 py-1 font-thin text-[#FD3550] border-[#FD3550] hover:bg-[#FD3550] hover:text-white">Delete</button>
        <button className="border px-3 py-1 font-thin border-[#6C757D] hover:text-white hover:bg-gray-400 text-gray-500">Excel</button>
