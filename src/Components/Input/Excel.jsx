...
const Excel = ({ Jpg, onClick, expotExcel, handeldelete }) => {
    ...
    return <div>
        ...
        <button onClick={expotExcel} className="border px-3 py-1 font-thin border-[#6C757D] hover:text-white dark:text-white dark:border-white hover:bg-gray-400 text-gray-500">Excel</button>
