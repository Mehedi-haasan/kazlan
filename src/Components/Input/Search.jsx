...
const Search = ({ SearchProduct }) => {
    ...
    return <div className="flex justify-start items-center gap-1.5 relative">
        ...
        {
            isCross && <svg onClick={()=>{setValue('');SearchProduct('')}} xmlns="http://www.w3.org/2000/svg" className={`absolute top-2 right-1 font-thin cursor-pointer ${value !== "" ?'text-black': "text-gray-400"} `} width="15" height="15" viewBox="0 0 24 24">
