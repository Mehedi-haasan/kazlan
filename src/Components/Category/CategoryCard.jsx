...
const CategoryCard = ({ item, i, isChecked, info = {}, getCategory, TikBox }) => {
    ...
    return (
        ...
        <tr className={`${i % 2 === 1 ? 'bg-[#FAF9EE] dark:bg-[#040404] dark:text-white' : 'bg-white dark:bg-[#1C2426] dark:text-white'} border-b border-x`}>
            <th className="w-4 py-1 px-4 border-r">
            ...
            <th scope="col" id="kalpurush" className="px-2 py-1 border-x font-thin">{item?.name}
                <Notification message={message} />
            </th>
            <th scope="col" className="px-2 py-1 border-r font-thin ">{item?.id}</th>
            <th scope="col" className="px-2 border-r font-thin ">
            ...
            <th scope="col" className=" py-1 flex justify-center items-center gap-2">
