        ...
        info?.role === "superadmin" && <th scope="col" className="px-2 py-2 flex justify-center items-center border-r gap-2 relative">
          {
            selected === item?.id && <div className="absolute -top-12 bg-white shadow-xl rounded-md right-14 w-[120px] p-1 z-50 border">
              ...
              <div onClick={() => { setShow(true); modalOpen(item?.id) }} className="flex justify-start items-center gap-2.5 cursor-pointer text-red-500 hover:bg-gray-200 px-[5px] py-[2px] rounded">
