                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-900 dark:text-gray-400">
                            <tr className='border-y text-[16px] py-1'>
                                ...
                                <th scope="col" className="py-2.5 text-center font-thin border-r">Qty</th>
                        ...
                        <tbody>
                            {allData?.map((item) => {
                                return <WholeSaleCard item={item} changeqty={ChangeQty} changedis={ChangeDiscount} changeprice={ChangePrice} ChangeDiscountType={ChangeDiscountType} onClick={HandleDelete} lastdiscount={user?.lastdiscount} />
                            })}
                        </tbody>
                    </table>
                </div>
