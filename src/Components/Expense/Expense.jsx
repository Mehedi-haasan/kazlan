        ...
        const rows = `
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; border:0px">
                    ${allData?.map(data => {
                        ...
                        let groupHtml = `<div style="">`; // start group container
                        ...
                        // Header row
                        groupHtml += `
                            <div style="border: 1px solid black; display: grid; grid-template-columns: 1fr 1fr 1fr; font-weight: bold; background:#f0f0f0;">
                                <div style="padding: 4px; border-right: 1px solid black; font-size: 13px;">Name</div>
                                <div style="padding: 4px; border-right: 1px solid black; font-size: 13px;">Invoice No</div>
                        ...
                        groupHtml += data?.items?.map(item => `
                            <div style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; display: grid; grid-template-columns: 1fr 1fr 1fr;">
                                ...
                                <div style="padding: 4px; text-align: right; font-size: 13px;">
                                    ${item?.total}
                                </div>
                            </div>
                        `).join("");
                        ...
                        groupHtml += `
                            <div style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; display: grid; grid-template-columns: 1fr 1fr;">
                                ...
                                <div style="padding: 4px; text-align: right; font-weight:bold;">${data?.total}</div>
                            </div>
                        `;
                                    ...
                                    <div>
                                      ...
                                      ${rows}
                                        ...
                                        <div style="display: grid; grid-template-columns: 1fr 1fr;">
                                          <p style="padding: 4px; border: 1px solid black;">Grand Total</p>
                                          <p style="padding: 4px; border: 1px solid black; text-align:right">${grandTotal}</p>
                                        </div>
                            ...
                            {allData?.map((data) => {
                                return <div>
                                    ...
                                    <div className='grid grid-cols-2 text-[14px] font-thin'>
                                        ...
                                        <h1 className='border-r border-b p-2 text-right'>{data?.total}</h1>
                                    </div>
                                </div>
                            })}
                        </div>
