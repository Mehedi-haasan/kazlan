...
const PurchaseProductCard = ({ item, changeqty, onClick }) => {
    ...
    return (
        <tr className='border-b'>
            ...
            <th scope="col" className="text-left font-thin border-l">
                <input placeholder={item?.qty} value={item?.qty} onChange={(e) => { changeqty(item?.id, e.target.value) }} className='w-full h-full py-2 focus:outline-none pl-4 ' />
            </th>
